...
* **Conceptuel** : ici, le [modèle entité-association](https://fr.wikipedia.org/wiki/Mod%C3%A8le_entit%C3%A9-association) (diagramme) ;
* **Logique** : ici, le [modèle relationnel](https://fr.wikipedia.org/wiki/Mod%C3%A8le_relationnel) ;
* **Physique** : implémentation avec un langage de requête et un système de gestion de bases de données.
